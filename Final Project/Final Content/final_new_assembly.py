            ...
            for test_node in local_to_global_node_array[element_number]:
                ...
                for trial_node in local_to_global_node_array[element_number]:
                    if unknown_node_matrix[int(test_node)] == -1.0 or unknown_node_matrix[int(trial_node)] == -1.0:
                        ...
                        if unknown_node_matrix[0] == -1.0:
                            print "PROGRESS"
                            print element_number,test_node,trial_node
                            stiffness_matrix[(y_point_array[int(test_node)]-1)*number_of_unknowns_in_x+(x_point_array[int(test_node)]-1),(y_point_array[int(trial_node)]-1)*number_of_unknowns_in_x+(x_point_array[int(trial_node)]-1)]+=(my_functions2.linear_basis_calculator(x_array,quad_point[0],x_point_array[int(test_node)])*my_functions2.derivative_basis_calculator(y_array,quad_point[1],y_point_array[int(test_node)])*my_functions2.linear_basis_calculator(x_array,quad_point[0],x_point_array[int(trial_node)])*my_functions2.derivative_basis_calculator(y_array,quad_point[1],y_point_array[int(trial_node)])+my_functions2.derivative_basis_calculator(x_array,quad_point[0],x_point_array[int(test_node)])*my_functions2.linear_basis_calculator(y_array,quad_point[1],y_point_array[int(test_node)])*my_functions2.derivative_basis_calculator(x_array,quad_point[0],x_point_array[int(trial_node)])*my_functions2.linear_basis_calculator(y_array,quad_point[1],y_point_array[int(trial_node)]))*area_element_array[0]
                            mass_matrix[(y_point_array[int(test_node)]-1)*number_of_unknowns_in_x+(x_point_array[int(test_node)]-1),(y_point_array[int(trial_node)]-1)*number_of_unknowns_in_x+(x_point_array[int(trial_node)]-1)]+=my_functions2.linear_basis_calculator(x_array,quad_point[0],x_point_array[int(test_node)])*my_functions2.linear_basis_calculator(y_array,quad_point[1],y_point_array[int(trial_node)])*area_element_array[0]
