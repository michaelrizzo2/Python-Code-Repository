...
def first_time_setup():
    ...
    number_of_employees=input("Please input the number of employees you want to add\n")
...
def extra_options():
    option=raw_input("Please input create, edit or delete\n")
    ...
    if option=="edit":
        ...
        employee=raw_input("Please input the employee you want to edit\n")
        ...
        my_os.system("vim %s" % str(employee_files[employee_number]))
    if option=="create":
    ...
    if option=="delete":
        ...
        user_to_delete=raw_input("Please input the employee you want to delete\n")
        employee_name_list=my_library.employee_name_list_getter()
...
def admin():
    first_time=raw_input("Please input yes for the first time or no for any other time\n")
...
def employee():
    ...
    employee_name=raw_input("Please input your name\n")
    ...
    my_os.system("cat %s" % employee_file_list[employee_index])
